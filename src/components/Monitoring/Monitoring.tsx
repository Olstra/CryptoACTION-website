                    ...
                    <tbody>{ initialData.map((r) => (
                        <tr key={r.address}>
                            ...
                            <td>
                                {r.transactions ? (
                                    <div>
                                        <p style={{background: "white"}}>Entry ID: {r.transactions.entryId}</p>
                                        <p style={{background: "white"}}>TX list: {r.transactions.txList}</p>
                                        <p style={{background: "white"}}>Case description: {r.transactions.caseDescription}</p>
                                    </div>
                                ) : (
